...
openai.api_key = 'sk-oCM2PCs7jd8WZMCAw3hc7CzF0ZW6yS9Ig8LQ7oqNAlT3BlbkFJKuy0AqXl6-ULpdjYGB7glC9n5vjDynWBy8EUFA3t0A'
# Load Q&A data from file
with open(r'ParentsPal/qa_pairs.json', 'r', encoding='utf-8') as file:
    qa_data = json.load(file)

# Load the pre-trained model
model = joblib.load(r'ParentsPal/SGDClassifier.joblib')
...
def chat(match_id):
    ...
    return render_template('chat.html', match=match, room_id=chat_room_id)


def load_chat_history(chat_room_id):
    # Load chat history from JSON or other storage based on room ID
...
def handle_send_message_event(data):
    ...
    message = {
        ...
        'receiver_id': data['receiver_id'],  # Make sure this exists in `data`
